...
public class UberBooking {
	...
	private String generateJsonString(String start_latitude, String start_longitude, String end_latitude,
			String end_longitude, String productId) throws JSONException {
	...
	public String requestUber(String start_latitude, String start_longitude, String end_latitude, String end_longitude,
			String productName, String accessToken) throws JSONException, IOException {

		// accessToken = "zhWsbVFfiE0zOJUqi0EHJgyqtARA0g";
		...
		try {
			...
			ClientResponse clientResponse = webResource.header("Content-Type", "application/json")
					.header("Authorization", authToken).post(ClientResponse.class, requestJsonString);
